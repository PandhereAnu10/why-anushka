      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          ...
          <SheetContent
            ...
            className="w-full sm:max-w-md bg-black border-l border-zinc-800 text-zinc-100 flex flex-col h-full p-0 gap-0 shadow-2xl backdrop-blur-md bg-opacity-90 font-sans"
          >
            {/* Header */}
